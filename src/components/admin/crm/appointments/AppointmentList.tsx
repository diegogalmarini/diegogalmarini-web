...
import Table, { Column, PaginationInfo } from '../ui/Table';
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
                  <Select
                    ...
                    onChange={(e) => setFilters(prev => ({ ...prev, status: e.target.value ? [e.target.value as Appointment['status']] : undefined }))}
                  ...
                  <Select
                    ...
                    onChange={(e) => setFilters(prev => ({ ...prev, type: e.target.value ? [e.target.value as Appointment['type']] : undefined }))}
                    options={typeOptions}
                  />
                  ...
                  <Select
                    ...
                    onChange={(e) => setFilters(prev => ({ ...prev, planType: e.target.value ? [e.target.value as Appointment['planType']] : undefined }))}
                  ...
                  <Select
                    ...
                    onChange={(e) => setFilters(prev => ({ ...prev, paymentStatus: e.target.value ? [e.target.value as Appointment['paymentStatus']] : undefined }))}
          ...
          <div className="bg-white rounded-lg border border-gray-200">
            ...
            <Table
              ...
              pagination={{
                ...
                hasNextPage: currentPage < Math.ceil(filteredAppointments.length / pageSize),
          ...
          <Calendar
            ...
            onEventClick={(event, date) => {
              if (event.type === 'appointment') {
                ...
                if (appointment && onViewAppointment) {
            ...
            onDateSelect={(date) => {
              if (onCreateAppointment) {
                // Aquí podríamos pasar la fecha preseleccionada si onCreateAppointment lo soportara
                onCreateAppointment();
              }
            }}
            className="p-6"
